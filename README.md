...
The platform is optimized for **Railway** deployment.

1.  **Connect GitHub**: Go to [Railway.app](https://railway.app), create a new project, and connect this GitHub repository.
2.  **Variables**: In the Railway dashboard, go to **Variables** and add `GEMINI_API_KEY`.
3.  **Procfile**: Railway will automatically detect the `Procfile` and start the server.
4.  **Access**: Your app will be live at `https://your-url.up.railway.app/app`.
